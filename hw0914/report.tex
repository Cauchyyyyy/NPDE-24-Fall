...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.47\textwidth}
    \centering
    \includegraphics[width=\textwidth]{0.01c.png}
    \caption{$FTCS$}

  \end{subfigure}
  \begin{subfigure}[b]{0.47\textwidth}
    \centering
    \includegraphics[width=\textwidth]{0.01f.png}
    \caption{$FTFS$}
...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{0.47\textwidth}
    \centering
    \includegraphics[width=\textwidth]{0.03c.png}
    \caption{$FTCS$}

  \end{subfigure}
  \begin{subfigure}[b]{0.47\textwidth}
    \centering
    \includegraphics[width=\textwidth]{0.03f.png}
    \caption{$FTFS$}
...
\subsection{Code}
\lstinputlisting[language=Matlab]{pg2.m}
